...
_STRINGS: Dict[str, Dict[str, str]] = {
    LANG_ZH: {
        ...
        # IPC Labels
        "ipc.friendly": "亲和",
        "ipc.dominantFriendly": "活跃",
        "ipc.dominant": "掌控",
        "ipc.dominantHostile": "高傲",
        "ipc.hostile": "冷淡",
        "ipc.submissiveHostile": "孤避",
        "ipc.submissive": "顺应",
        "ipc.submissiveFriendly": "谦让",
        "ipc.unknown": "未知",
    ...
    LANG_EN: {
        ...
        # IPC Labels
        "ipc.friendly": "Friendly",
        "ipc.dominantFriendly": "Outgoing",
        "ipc.dominant": "Dominant",
        "ipc.dominantHostile": "Arrogant",
        "ipc.hostile": "Cold",
        "ipc.submissiveHostile": "Withdrawn",
        "ipc.submissive": "Submissive",
        "ipc.submissiveFriendly": "Humble",
        "ipc.unknown": "Unknown",
    ...
    LANG_JA: {
        ...
        "projector.power": "支配度",
        "projector.intensity": "感情強度",
        "projector.r_squared": "適合度",
        "projector.last_reinforced": "最終強化",
        "projector.evidence": "**証拠イベント：** ",
        "projector.no_impressions": "印象記録はありません",
        "projector.profile_desc": "> このファイルはプラグインによって自動生成されます。直接編集しないでください。印象記録を変更するには、同じディレクトリ内の IMPRESSIONS.md を編集してください。",
        "projector.uid": "内部 UID",
        ...
        # IPC Labels
        "ipc.friendly": "親和的",
        "ipc.dominantFriendly": "社交的",
        "ipc.dominant": "支配的",
        "ipc.dominantHostile": "傲慢的",
        "ipc.hostile": "冷淡な",
        "ipc.submissiveHostile": "離絶的",
        "ipc.submissive": "服従的",
        "ipc.submissiveFriendly": "謙虚な",
        "ipc.unknown": "未知",

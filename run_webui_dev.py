...
async def _seed(
    ...
    for e in [
        Event(
            ...
            interaction_flow=[], topic="早安问候", summary="Alice 和 Bob 互相早安问候，气氛融洽。",
        ...
        Event(
            ...
            participants=["demo_uid_alice", "demo_uid_bob", "demo_uid_bot"],
            interaction_flow=[], topic="音乐推荐", summary="分享了一些古典乐和流行乐，探讨了跨文化艺术。",
        ...
        Event(
            ...
            interaction_flow=[], topic="游戏约定", summary="商定了周末晚上的组队排位计划，分配了位置。",
        ...
        Event(
            ...
            interaction_flow=[], topic="技术交流", summary="讨论了 Python 异步 IO 的一些高级用法和性能调优。",
        ...
        Event(
            ...
            interaction_flow=[], topic="私聊请教", summary="Alice 向 BOT 请教了关于记忆存储机制的一些细节，表现出浓厚兴趣。",
